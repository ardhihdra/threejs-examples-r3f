...
Command: npx gltfjsx@6.2.4 LittlestTokyo.glb --transform
...
export function LittlestTokyoModel(props) {
  const group = useRef()
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="OSG_Scene">
        ...
        <mesh name="Object649_metalmat_0" geometry={nodes.Object649_metalmat_0.geometry} material={materials.metalmat} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_Plastic_Soft_0" geometry={nodes.Object649_Plastic_Soft_0.geometry} material={materials.Plastic_Soft} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_alpha_glass_0" geometry={nodes.Object649_alpha_glass_0.geometry} material={materials.alpha_glass} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_glassmat_0" geometry={nodes.Object649_glassmat_0.geometry} material={materials.glassmat} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_Material_#5511_0" geometry={nodes['Object649_Material_#5511_0'].geometry} material={materials.Material_5511} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_Material_#5512_0" geometry={nodes['Object649_Material_#5512_0'].geometry} material={materials.Material_5512} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_glass_transp_0" geometry={nodes.Object649_glass_transp_0.geometry} material={materials.glass_transp} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_interiors_0" geometry={nodes.Object649_interiors_0.geometry} material={materials.interiors} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object649_alpha_0" geometry={nodes.Object649_alpha_0.geometry} material={materials.alpha} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object674_outline_0" geometry={nodes.Object674_outline_0.geometry} material={materials.outline} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object705_Material_#5516_0" geometry={nodes['Object705_Material_#5516_0'].geometry} material={materials.Material_5516} position={[-85.046, 5.403, -25.433]} rotation={[-Math.PI / 2, 0, 0]} />
        <mesh name="Object619_alpha_0" geometry={nodes.Object619_alpha_0.geometry} material={materials.alpha_0} position={[-80.312, -138.966, 183.664]} rotation={[-1.891, 0.86, -1.371]} scale={0.792} />
